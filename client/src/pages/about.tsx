        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-brand-slate">My Journey</h2>
            ...
            <div className="relative">
              <img 
                src="https://images.unsplash.com/photo-1494790108755-2616c96fb2ce?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=600" 
          ...
          {/* Certifications */}
          <div className="mb-20">
            <h2 className="text-3xl font-bold text-brand-slate text-center mb-12">Certifications & Credentials</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Tag className="h-8 w-8 text-brand-blue" />
                </div>
                <h3 className="font-bold text-brand-slate mb-2">Certified Instructional Designer</h3>
                <p className="text-sm text-slate-600">Professional certification in instructional design principles and practices</p>
              </div>
              ...
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                ...
                <h3 className="font-bold text-brand-slate mb-2">Design Thinking Certified</h3>
                <p className="text-sm text-slate-600">Human-centered design approach for innovation and problem-solving</p>
              </div>
              ...
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                ...
                <h3 className="font-bold text-brand-slate mb-2">Learning Science</h3>
                <p className="text-sm text-slate-600">Evidence-based approaches to learning and cognitive psychology</p>
              </div>
